...
public class EarlyLoaderGUI {
    ...
    private final MessageFormat memoryFormat = new MessageFormat("Memory Heap: {0,number,integer} / {1,number,integer} MB ({2,number,percent})  OffHeap: {3,number,integer} MB");
